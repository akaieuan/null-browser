...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::chats::chat_create_conversation,
            commands::chats::chat_list_conversations,
            commands::chats::chat_get_messages,
            commands::chats::chat_rename_conversation,
            commands::chats::chat_delete_conversation,
